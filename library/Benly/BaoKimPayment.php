...
class Benly_BaoKimPayment 
{
	// URL checkout của baokim.vn
	private $baokim_url = 'https://www.baokim.vn/payment/customize_payment/order';

	// Mã merchante site 
	private $merchant_id = '6322';	// Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site

	// Mật khẩu bảo mật
	private $secure_pass = '47a93413cb1d5bf5'; // Biến này được baokim.vn cung cấp khi bạn đăng ký merchant site
	 ...
	 * @param $business 			Email tài khoản người bán: infor@benlytourist.com.vn
	 ...
	 * @return url cần tạo
	 */
	public function createRequestUrl($order_id, $business = "infor@benlytourist.com.vn", $total_amount, $shipping_fee, $tax_fee, $order_description, $url_success, $url_cancel, $url_detail)
	{
