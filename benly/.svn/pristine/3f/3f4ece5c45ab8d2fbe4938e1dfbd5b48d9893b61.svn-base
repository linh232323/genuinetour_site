...
class Benly_NLCheckout 
{
	...
	private $merchant_site_code = '25535'; //100001 chỉ là ví dụ, bạn hãy thay bằng mã của bạn

	// Mật khẩu giao tiếp giữa website của bạn và NgânLượng.vn.
	private $secure_pass= '123abc!@#'; //d685739bf1 chỉ là ví dụ, bạn hãy thay bằng mật khẩu của bạn
